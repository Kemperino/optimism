...
/// - The observer hooks must never synthesize call/create outcomes and must not mutate EVM state. A
///   non-observing implementor can leave all observer hooks at their default no-op behavior.
